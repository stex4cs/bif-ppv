...
<head>
    ...
    <meta property="og:title" content="Nikola Belička - Nidza - BIF Borac">
    <meta property="og:description" content="Pogledajte profil i istoriju borbi za Nikolu Beličku - Nidza.">
    <meta property="og:type" content="profile">
    <meta property="og:url" content="https://bif.events/fighter-details.html?fighter=nikola-belicka">
    <meta property="og:image" content="/assets/images/fighters/nidja.png">
    ...
    <title>Nikola Belička - Nidza - Detalji Borca | BIF</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "image": "https://bif-fighting.com/assets/images/fighters/nidja.png",
        "url": "https://bif-fighting.com/fighter-details.html?fighter=nikola-belicka",
        "height": "183 cm",
        "weight": "75 kg",
            ...
            <div class="container">
                <div class="fighter-profile-grid">
                    <div class="fighter-image-container">
                        <img src="/assets/images/fighters/nidja.png" alt="Nikola Belička - Nidza" loading="lazy">
                    </div>
                    <div class="fighter-info-container">
                        <div class="fighter-header">
                            <h1>
                                <span class="lang-content active" data-lang="sr">NIKOLA BELIČKA</span>
                                <span class="lang-content" data-lang="en">NIKOLA BELIČKA</span>
                                <span class="fighter-age">, 19</span>
                            </h1>
                            <p class="fighter-nickname">"Nidza"</p>
                        ...
                        <div class="fighter-attributes">
                            <div class="attribute-item">
                                ...
                                <span class="value">183 CM (6'0 FT)</span>
                            </div>
                            <div class="attribute-item">
                                ...
                                <span class="value">75 KG (165 LBS)</span>
                            </div>
                            <div class="attribute-item">
                            ...
                            <div class="attribute-item">
                                ...
                                <span class="value">Kick Box</span>
                            </div>
                            <div class="attribute-item">
                            ...
                            <div class="attribute-item">
                                ...
                                <span class="value">Bačka Palanka</span>
                            </div>
                            <div class="attribute-item">
                        ...
                        <div class="fighter-social-media">
                           <a href="https://www.tiktok.com/@nidjasmols?_t=ZN-8xUoKDSWSIg&_r=1" class="social-link" aria-label="TikTok" target="_blank" rel="noopener">
                            <i class="fab fa-tiktok"></i></a>
                            <a href="https://www.instagram.com/_nikolabelicka_?igsh=MmdmbTFrMjFneHkz" class="social-link" aria-label="Instagram" target="_blank" rel="noopener">
