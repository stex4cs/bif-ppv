...
<head>
    ...
    <meta property="og:title" content="Dejan Rančev - Rančev - BIF Borac">
    <meta property="og:description" content="Pogledajte profil i istoriju borbi za Dejana Rančeva - Rančev.">
    <meta property="og:type" content="profile">
    <meta property="og:url" content="https://bif.events/fighter-details.html?fighter=dejan-rancev">
    <meta property="og:image" content="/assets/images/fighters/rancev.png">
    ...
    <title>Dejan Rančev - Rančev - Detalji Borca | BIF</title>
    ...
    <script type="application/ld+json">
    {
        ...
        "image": "https://bif-fighting.com/assets/images/fighters/rancev.png",
        "url": "https://bif-fighting.com/fighter-details.html?fighter=dejan-rancev",
        "height": "181 cm",
        "weight": "85 kg",
            ...
            <div class="container">
                <div class="fighter-profile-grid">
                    <div class="fighter-image-container">
                        <img src="/assets/images/fighters/rancev.png" alt="Dejan Rančev - Rančev" loading="lazy">
                    </div>
                    <div class="fighter-info-container">
                        <div class="fighter-header">
                            <h1>
                                <span class="lang-content active" data-lang="sr">DEJAN RANČEV</span>
                                <span class="lang-content" data-lang="en">DEJAN RANČEV</span>
                                <span class="fighter-age">, 19</span>
                            </h1>
                            <p class="fighter-nickname">"Rančev"</p>
                            <p class="fighter-category-details">
                                <span class="lang-content active" data-lang="sr">POLUTEŠKA KATEGORIJA</span>
                                <span class="lang-content" data-lang="en">LIGHT HEAVYWEIGHT</span>
                            </p>
                        </div>
                        ...
                        <div class="fighter-attributes">
                            <div class="attribute-item">
                                ...
                                <span class="value">181 CM (5'11 FT)</span>
                            </div>
                            <div class="attribute-item">
                                ...
                                <span class="value">85 KG (187 LBS)</span>
                            </div>
                            <div class="attribute-item">
                            ...
                            <div class="attribute-item">
                                ...
                                <span class="value">05.10.2005.</span>
                            </div>
                        </div>

                        <div class="fighter-social-media">
                           <a href="https://www.tiktok.com/@d.rancev?_t=ZN-8xUoFmS1xZu&_r=1" class="social-link" aria-label="TikTok" target="_blank" rel="noopener">
                            <i class="fab fa-tiktok"></i></a>
                            <a href="https://www.instagram.com/d.rancev?igsh=MW8yNzkxaXUzMHNpYg==" class="social-link" aria-label="Instagram" target="_blank" rel="noopener">
