...
<body>
    <div class="links-wrap">
        ...
        <!-- Instagram (MAIN) -->
        <a href="https://www.instagram.com/bif.events/" target="_blank" rel="noopener" class="link-btn link-btn--instagram link-btn--with-badge">
            <span class="partner-badge" style="background:linear-gradient(135deg,#f09433,#dc2743);border-color:rgba(255,215,0,0.5);">MAIN PROFILE</span>
            <span class="ico">
            ...
            <span class="label">Instagram · @bif.events</span>
        </a>

        <!-- Instagram (Lollipop fan account) -->
        ...
        <a href="https://kick.com/trajkomusic" target="_blank" rel="noopener" class="link-btn link-btn--kick link-btn--with-badge">
